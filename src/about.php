    ...
    <section class="bg-theme-clr-light dark:text-on-theme-clr-light py-12 lg:py-20">
        <div class="mg-main-container">
            <div class="grid grid-cols-12 gap-8 md:gap-12">
                ...
                <!--  -->
                <div class="col-span-12 md:col-start-4 md:col-end-13 bg-theme-clr-white p-4 lg:p-6 shadow-sm rounded-lg fade-in" data-delay="400">
                    <div class="flex flex-col items-start jusify-center gap-2 md:gap-4">
                        <h2 class="text-xl lg:text-3xl font-semibold">Vanlagos </h2>
                        <p class="lg:text-lg">
                ...
                <!--  -->
                <!-- <div class="col-span-4 bg-theme-clr-white p-4 lg:p-6 shadow-sm rounded-lg fade-in" data-delay="400">
                    vv
                </div> -->

                <!-- <div class="col-span-12 md:col-start-4"> -->
                <div class="col-span-12 bg-theme-clr-white p-4 lg:p-6 shadow-sm rounded-lg fade-in" data-delay="400">
                    <div class="flex flex-col items-start jusify-center gap-2 md:gap-4">
                        <h2 class="text-xl lg:text-3xl font-semibold">Studios Mainland</h2>
