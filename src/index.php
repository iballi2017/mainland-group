            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative overflow-hidden h-56 md:h-[567px]">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        ...
                        <div class="absolute z-2 bg-accent-500 block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                            <div class="text-center text-white bg-primary-50 max-w-2xl mx-auto">
                                <p class="text-4xl font-bold">Ignite Innovations</p>
                                <p class="">Transforming Visions into Reality: Your Partner in Cutting-Edge Solutions</p>
                            </div>
                        </div>
                    </div>
                    <!-- Slide 2 -->
