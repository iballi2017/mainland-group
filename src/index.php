...
<main>
            ...
            <div class="w-full text-center bg-theme-clr-white dark:text-on-theme-clr-white relative">
                <div class="owl-carousel owl-theme | hero-carousel">
                    <div class="duration-700 ease-in-out h-56 lg:h-[600px]">
                        ...
                        <div class="absolute z-2 block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                            <div class="text-center text-white max-w-2xl mx-auto">
                                <h1 class="text-xl lg:text-6xl font-bold animate__animated animate__pulse">Brighten Your Future with Solar</h1>
                                <p class="leading-normal lg:text-2xl font-semibold animate__animated animate__fadeInUp">
                    ...
                    <div class="duration-700 ease-in-out h-56 lg:h-[600px]">
                        ...
                        <div class="absolute z-2 block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                            <div class="text-center text-white max-w-2xl mx-auto">
                                <h1 class="text-xl lg:text-6xl font-bold">Ignite Innovations</h1>
                                <p class="leading-normal lg:text-2xl font-semibold">Transforming Visions into Reality: Your
                    ...
                    <div class="duration-700 ease-in-out h-56 lg:h-[600px]">
                        ...
                        <div class="absolute z-2 block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                            <div class="text-center text-white max-w-2xl mx-auto">
                                <h1 class="text-xl lg:text-6xl font-bold">Inspiring Excellence Together</h1>
                                <p class="leading-normal lg:text-2xl font-semibold">
                ...
                <div class="dots-wrapper playing | absolute bottom-0 left-0 right-0 z-10 pb-2 md:pb-4 lg:pb-8">
                    ...
                    <div class="rounded-full p-[2px] relative inline-flex items-center gap-4 mt-8">
                        ...
                        <div class="control-wrapper | hidden">
                            <button
                                class="play-slider-btn | focus:outline-none focus:ring focus:ring-primary-alt h-[20px] w-[20px] rounded-full border-2 border-[hsl(0, 0%, 74%)] cursor-pointer"
                                aria-label="play"></button>
                            <button
                                class="pause-slider-btn | focus:outline-none focus:ring focus:ring-primary-alt h-[20px] w-[20px] rounded-full border-2 border-[hsl(0, 0%, 74%)] cursor-pointer"
        ...
        <div class="mg-main-container">
            ...
            <div class="grid grid-cols-12 gap-4 lg:gap-8 items-center max-w-[1200px] mx-auto">
                <div class="col-span-12 md:col-span-6 hidden md:block">
                    <div>
                        <img loading="lazy" src="./assets/images/featured-image-1.png"
                            alt="KNOW ABOUT MAINLAND EDGE BUSINESS" class="w-full">
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6 text-on-theme-clr-white">
                    ...
                    <p>We are a dynamic conglomerate committed to innovation, excellence, and community service. Our
                        mission is to deliver top-quality services and products that enhance the lives of our customers
                        and contribute to sustainable development. </p>
                    <div class="h-2 md:h-4"></div>
                    <?php
                    $label = "Read more";
                    $url = "#";
    ...
    <?php include("./components/project-highlights.php"); ?>



    <section class="bg-theme-clr-secondary text-on-theme-clr-secondary py-12 lg:py-20">
        <div class="mg-main-container flex flex-col flex-wrap items-center justify-between mx-auto md:px-4 fade-in"
            data-delay="200">
            ...
            <div class="w-full max-w-[1050px] mx-auto text-center fade-in" data-delay="600">
                <div class="owl-carousel owl-theme | testimonial-carousel" id="testimonial-carousel">
                    <blockquote
                        class="md:h-56 text-sm grid grid-cols-3 items-center gap-y-4 md:gap-y-0 bg-theme-clr-white text-on-theme-clr-white rounded-md p-4 md:px-4 md:py-8">
                        ...
                        <div
                            class="col-span-3 md:col-span-2 h-full flex items-center overflow-hidden md:border-s md:border-on-theme-clr-white md:ps-4 md:pe-4 text-center md:text-left">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. consectetur adipiscing elit, Quis ipsum suspendisse
                            </p>
                        </div>
                    </blockquote>
                    <blockquote
                        ...
                        <div
                            class="col-span-3 md:col-span-2 h-full flex items-center overflow-hidden md:border-s md:border-on-theme-clr-white md:ps-4 md:pe-4 text-center md:text-left">
                            <p>
                                Commodi sapiente sequi voluptas ex quasi, quia mollitia dolorum distinctio at facilis
                                similique aliquid omnis eos aspernatur fuga doloribus minima voluptates nostrum
                                assumenda asperiores veritatis.
                            </p>
                        </div>
                    </blockquote>
                    <blockquote
                        ...
                        <div
                            class="col-span-3 md:col-span-2 h-full flex items-center overflow-hidden md:border-s md:border-on-theme-clr-white md:ps-4 md:pe-4 text-center md:text-left">
                            <p>
                                Eaque hic nam voluptate. Voluptatem tempora ab officia et laudantium unde laboriosam
                                corrupti inventore? Iusto expedita molestiae inventore.
                            </p>
                        </div>
                    </blockquote>
                    <blockquote
                        ...
                        <div
                            class="col-span-3 md:col-span-2 h-full flex items-center overflow-hidden md:border-s md:border-on-theme-clr-white md:ps-4 md:pe-4 text-center md:text-left">
                            <p>
                                Sit officiis pariatur natus temporibus cum iure? Reprehenderit culpa, nobis
                                necessitatibus dolor totam nesciunt minus nihil placeat saepe molestias vitae facilis
                                maxime!
                            </p>
                        </div>
                    </blockquote>
                ...
                <!-- Custom dots -->
                <div
                    class="dots-wrapper | bg-theme-clr-secondary dark:text-on-theme-clr-secondary relative inline-flex items-center gap-4 mt-8">
        ...
        <div class="mg-main-container flex flex-col flex-wrap mx-auto md:px-4">
            ...
            <div class="flex items-center justify-between gap-8">
                ...
                <div class="flex items-center gap-6">
                    <div
                        class="h-24 w-[18px] bg-gradient-to-b from-[#AACE48] via-[#12AD58] to-[#1B3512] rounded-t-full rounded-b-full">
                    </div>
                    <div>
                ...
                <a href="#"
                    class="focus:outline-none focus:ring focus:ring-primary-alt text-sm hover:bg-white/50 block uppercase border border-on-theme-clr-white py-2 px-4 rounded-lg whitespace-nowrap fade-in"
                    data-delay="500">View all</a>
            </div>
            ...
            <div class="w-full text-center fade-in" data-delay="200">
                <div class="owl-carousel owl-theme | blogpost-carousel" id="blogpost-carousel">
                    <div
                        ...
                        <a href="#" class="block h-56 md:h-72 overflow-hidden">
                            <img loading="lazy" class="rounded-t-lg"
                                src="./assets/images/power-outage-looms-round-the-nation-after-power-grid-collapse.png"
                        ...
                        <div class="p-5 text-left">
                            ...
                            <a href="#" class="hover:text-primary">
                                <h3 class="mb-2 text-xl md:text-2xl font-bold tracking-tight h-[90px] md:h-[100px] overflow-hidden"
                                    ...
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui natus amet quam
                                    deleniti ipsum praesentium possimus quis vitae eveniet veniam assumenda fugiat,
                                    soluta ab minima doloribus veritatis quo eaque? Commodi saepe, inventore sequi optio
                                    praesentium iste nemo hic molestiae accusamus!
                                </h3>
                            </a>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-5 text-left">
                            ...
                            <a href="#" class="hover:text-primary">
                                <h3
                                    class="mb-2 text-xl md:text-2xl font-bold tracking-tight h-[90px] md:h-[100px] overflow-hidden">
                    ...
                    <div
                        ...
                        <a href="#" class="block h-56 md:h-72 overflow-hidden">
                            <img loading="lazy" class="rounded-t-lg"
                                src="./assets/images/fuel-scarcity-and-hike-in-price-may-cause-slow-productivity.png"
                                alt="Fuel Scarcity and hike in price may cause slow productivity.">
                        </a>
                        <div class="p-5 text-left">
                            <div class="flex items-center justify-between gap-8 text-sm">
                                <span><i class="far fa-calendar me-2"></i>May 10, 2021</span>
                    ...
                    <div
                        ...
                        <a href="#" class="block h-56 md:h-72 overflow-hidden">
                            <img loading="lazy" class="rounded-t-lg"
                                src="./assets/images/food-price-increases-by-200-percent-progression-say-it-may-increase.png"
                                alt="food price increases by 200%, progression say it may increase">
                        </a>
                        <div class="p-5 text-left">
                            <div class="flex items-center justify-between gap-8 text-sm">
                                <span><i class="far fa-calendar me-2"></i>May 10, 2021</span>
                ...
                <!-- Custom dots -->
                <div
                    class="dots-wrapper | bg-theme-clr-white dark:text-on-theme-clr-light relative inline-flex items-center gap-4 mt-8">
