    ...
    <div class="mg-main-container items-center">
        ...
        <ul class="grid grid-cols-12 gap-2 md:gap-8 w-full">
            ...
            <li class="col-span-12 lg:col-span-6 relative">
                <div
                    class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <img class="rounded-lg" src="./assets/images/_MG_1808-min.png" alt="Studiomainland Filmaking Training Programme" />
                </div>
                <div class="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center">
...
<div id="default-modal3" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative overflow-hidden bg-white rounded-lg shadow dark:bg-gray-700">
            <!-- Modal header -->
            <button type="button" onclick="videoController.stopVideo('player3')" class="absolute z-40 right-4 top-4 text-gray-300 bg-transparent hover:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal3">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                </svg>
                <span class="sr-only">Close modal</span>
            ...
            <!-- Modal body -->
            <div class="video-container | p-2 md:p-4 space-y-4">
                <iframe id="player3" width="100%" height="480" src="https://www.youtube.com/embed/Ne-zhw_flRI?enablejsapi=1"
                    title="TEPCAN Inauguration: Celebrating the Launch of The Education Project Associate Network"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <button onclick="videoController.toggleVideo('player3')" class="absolute z-20 top-0 bottom-0 left-0 right-0" aria-label="play">
                    <span class="sr-only">Play</span>
                </button>
            </div>
        </div>
